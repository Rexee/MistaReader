...
import static com.mistareader.util.views.frescoZoomable.ZoomableDraweeView.ZOOM_ANIMATION_DURATION_MS;
...
public class DoubleTapGestureListener extends GestureDetector.SimpleOnGestureListener {
    ...
    public boolean onDoubleTapEvent(MotionEvent e) {
        ZoomableController zc = mDraweeView.getZoomableController();
        ...
        switch (e.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                if (mDoubleTapScroll) {
                    ...
                    final float midScale = zc.getMidScaleFactor();
                    final float minScale = zc.getMinScaleFactor();
                    if (zc.getScaleFactor() < (midScale + minScale) / 2) {
                        zc.zoomToPoint(
                                midScale,
                                ip,
                                vp,
                                ZoomableController.LIMIT_ALL,
