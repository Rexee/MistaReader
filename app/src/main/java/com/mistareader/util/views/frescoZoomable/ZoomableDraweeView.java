...
public class ZoomableDraweeView extends DraweeView<GenericDraweeHierarchy>
    ...
    private void init() {
        mSimpleDraweeControllerBuilder = Fresco.getDraweeControllerBuilderSupplier().get();
    ...
    protected ZoomableController createZoomableController() {
        return ZoomableController.newInstance();
    }

    public void onBackPressed() {
        PointF vp = new PointF(0, 0);
        PointF ip = mZoomableController.mapViewToImage(vp);

        mZoomableController.zoomToPoint(
                mZoomableController.getMinScaleFactor(),
                ip,
                vp,
